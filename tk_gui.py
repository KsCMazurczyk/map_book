...
ramka_formularzy = Frame(root)
ramka_szczegoly_obiektow = Frame(root)
ramka_mapa = Frame(root)

ramka_lista_obiektow.grid(row=0, column=0, padx=50)
ramka_formularzy.grid(row=0, column=1)
...
#ramka_formularz
label_formularz = Label(ramka_formularzy, text="Formularz")
label_name = Label(ramka_formularzy, text="Imię:")
label_surname = Label(ramka_formularzy, text="Nazwisko:")
label_posts = Label(ramka_formularzy, text="Liczba postów:")
label_location = Label(ramka_formularzy, text="Miejscowość:")

entry_name = Entry(ramka_formularzy)
entry_surname = Entry(ramka_formularzy)
...
map_widget.set_position(52.23, 21.) #Warszawa
